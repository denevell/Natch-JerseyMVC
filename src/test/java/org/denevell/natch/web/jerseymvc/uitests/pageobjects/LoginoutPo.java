...
public class LoginoutPo {
  ...
  public LoginoutPo shouldntSeeLoginButton() {
    org.junit.Assert.assertFalse(driver.getPageSource().contains(
        "login_form_submit"));
    return this;
  }

  public LoginoutPo shouldSeeBlankUsernameOrPassError() {
    boolean source = driver.getPageSource().contains(
        Strings.getBlankUsernameOrPassword());
  ...
  public LoginoutPo shouldBeOnHomepage() {
    org.junit.Assert.assertTrue(driver.getCurrentUrl()
        .startsWith(URLs.HOMEPAGE));
    return this;
  }
