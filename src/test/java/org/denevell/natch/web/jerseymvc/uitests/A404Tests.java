...
public class A404Tests {
	...
	// Not an useless test since we've got the server got into a stackoverflow before...
	@Test
	public void shouldSee404() throws InterruptedException {
	    try {
	        HttpURLConnection.setFollowRedirects(false);
	        HttpURLConnection con = (HttpURLConnection) new URL(URLs.HOMEPAGE+"/dsfsdf").openConnection();
